...
scoreboard players set @s[scores={cool3=0}] temp1 1
scoreboard players set @s[scores={temp1=0}] result3 1

scoreboard players operation @s[scores={temp1=1}] mana -= @s skill3_mana
scoreboard players set @s[scores={temp1=1, mana=0..}] result2 1
scoreboard players set @s[scores={temp1=1, mana=..-1}] result3 2
scoreboard players operation @s[scores={temp1=1, mana=..-1}] mana += @s skill3_mana
